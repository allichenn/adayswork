...
public class playerMove : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D other){
        ...
        if(other.gameObject.name == "red" && redRiddle == true){
            ...
            eggActive = true;
        } else if(other.gameObject.name == "egg" && eggActive == true){
            ...
            eggActive = false;
            orangeRiddle = true;
        } else if(other.gameObject.name == "orange" && orangeRiddle == true){
            keyText.text = "HELP ME FIND SOMETHING THAT IS \nORANGE AND SOUNDS LIKE PARROT!";
            Debug.Log("touched orange");
            carrotActive = true;
        } else if(other.gameObject.name == "carrot" && carrotActive == true){
            ...
            carrotActive = false;
            yellowRiddle = true;
        } else if(other.gameObject.name == "yellow" && yellowRiddle == true){
        ...
        } else if(other.gameObject.name == "watermelon" && watermelonActive == true){
            ...
            greenRiddle = true;
        } else if(other.gameObject.name == "green" && greenRiddle == true){
            keyText.text = "WHAT I AM LOOKING FOR HAS NO\nBEGINNING, MIDDLE, OR END.";
            Debug.Log("touched green");
            donutActive = true;
        } else if(other.gameObject.name == "donut" && donutActive == true){
